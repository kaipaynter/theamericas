...
const AboutPage = () => (
  <Layout fullMenu>
    <article id="main">
      ...
      <p className='center'>
        Founded in 2023, The Americas is an American-led theatre company, operating out of Sydney, Australia. It holds the distinction of being the only American-led theatre company in Australia. The Americas commitment is to bring diverse, high-standard, American shows to the beautiful Australian stages.
      </p>
      <p className='center'>
        <h4>Mission</h4>
